...
"""This is, I believe Django-generated."""
...
class Bodypart(models.Model):
    ...
    name = models.CharField('Bodypart name',
                            max_length=191,
                            blank=True,
                            null=True,
                            unique=True
                           )
    parent = models.ForeignKey('Bodypart',
                               null=True,
...
class Captive(models.Model):
    """Whether the specimen caught in the wile or a captive."""
...
class Continent(models.Model):
    ...
    name = models.CharField('Continent name',
                            max_length=32,
                            blank=True,
                            unique=True,
                            choices=CHOICES
...
class Country(models.Model):
    ...
    name = models.CharField('Country name',
                            max_length=191,
                            blank=False,
                            null=False,
                            unique=False,
    ...
    abbr = models.CharField('Abbreviation',
                            max_length=8,
                            blank=True,
                            null=True,
                            unique=True
...
class Datatype(models.Model):
    ...
    data_table = models.CharField('Data type', max_length=32,
                                  blank=True,
                                  null=True,
                                  choices=TYPES,
                                 )
...
class Fossil(models.Model):
    ...
    name = models.CharField('Fossil or Extant',
                            max_length=16,
                            blank=True,
                            null=True,
                           )
...
class Institute(models.Model):
    ...
    name = models.CharField('Institute',
                            max_length=255,
                            blank=False,
                            null=False,
                           )
    institute_department = models.CharField('Department',
                                            max_length=255,
                                            blank=True,
                                            null=True,
                                           )
...
class IslandRegion(models.Model):
    """Stores list of islands or regions. Used in ."""
    name = models.CharField('Region Name',
                            max_length=255,
                            blank=True,
                            null=False,
                            default=10000,
...
class Locality(models.Model):
    ...
    and island region.
    """
    name = models.CharField('Locality',
                            max_length=191,
                            blank=True,
                            null=True,
                           )
    ...
    island_region = models.ForeignKey('IslandRegion',
                                      null=False,
                                      on_delete=models.SET_DEFAULT,
                                      default=10000,
                                     )
...
class Protocol(models.Model):
    label = models.CharField('Protocol label',
                             max_length=255,
                             blank=True,
                             null=True
                            )
...
class QueryWizardTable(models.Model):
    query_wizard_query = models.ForeignKey('QueryWizardQuery',
                                           related_name='tables',
                                           on_delete=models.PROTECT,
                                          )
...
class Rank(models.Model):
    name = models.CharField('Rank name', 
                            max_length=255, 
                            blank=True, 
                            null=True)
    comments = models.TextField(blank=True, null=True)
...
class Sex(models.Model):
    ...
    name = models.CharField('Sex', max_length=16,
                            blank=True,
                            null=True,
                            choices=CHOICES,
                           )
...
class Taxon(models.Model):
    ...
    name = models.CharField('Taxon name',
                            max_length=255,
                            blank=True,
                            null=False,
                           )
...
class SpecimenType(models.Model): # wanted to use 'Type', but table already exists, and also `type` is a reserved word.
    CHOICES = (('holotype', 'holotype'),
               ('lectotype', 'lectotype'),
               ('syntype', 'syntype'),
               ('neotype', 'neotype'),
...
class Variable(models.Model):
    ...
    laterality = models.ForeignKey(Laterality,
                                   null=True,
                                   on_delete=models.PROTECT,
                                  )
    datatype = models.ForeignKey(Datatype, on_delete=models.PROTECT)
    paired_with = models.ForeignKey('Variable',
                                    null=True,
                                    on_delete=models.PROTECT,
                                   )
    comments = models.TextField(blank=True, null=True)
...
class Specimen(models.Model):
    ...
    age_class = models.ForeignKey(Ageclass,
                                  on_delete=models.PROTECT,
                                  blank=False,
                                  null=False,
                                  default=9,
                                 )
    fossil = models.ForeignKey(Fossil,
                               on_delete=models.PROTECT,
                               blank=False,
                               null=False,
                               default=9,
                              )
    captive = models.ForeignKey(Captive,
                                on_delete=models.PROTECT,
                                blank=False,
                                null=False,
                                default=9,
